...
ActiveRecord::Schema.define(version: 20171212124752) do
  ...
  create_table "ecetexams", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "livetests", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "cet"
    t.string "subject"
    t.integer "testcount"
    t.string "status"
  ...
  create_table "testcounts", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "testcount"
    t.integer "userid"
    t.string "cet"
    t.string "subject"
